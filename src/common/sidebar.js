            ...
            <Col xs={12}>
              ...
              <div className='sidebar-nav-container'>
                <SidebarNav style={{marginBottom: 0}} ref={(c) => this._nav = c}>
                  ...
                  <SidebarNavItem glyph='icon-fontello-gauge' name='Companies' href='/companies' />
                  <SidebarNavItem glyph='icon-fontello-gauge' name='Managers' href='/managers' />
                  <SidebarNavItem glyph='icon-fontello-gauge' name='Drivers' href='/drivers' />
                  <SidebarNavItem glyph='icon-fontello-gauge' name='Owners' href='/owners' />
